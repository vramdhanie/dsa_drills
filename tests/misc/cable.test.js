const { cable1, cable2 } = require("../../src/misc/cable");
...
describe("The Cable problem", () => {
  describe("Algorithm 1", () => {
    ...
    describe("The running time", () => {
      it("should take <100000n to count 1000", () => {
      ...
      it("should take <1000000n to count 5,000", () => {
        const start = process.hrtime.bigint();
        cable1(1, 5001, 1);
        const end = process.hrtime.bigint();
        const runningTime = end - start;
      ...
      it("should take <100,000,000n to count 10,000", () => {
        const start = process.hrtime.bigint();
        cable1(1, 10001, 1);
        const end = process.hrtime.bigint();
        const runningTime = end - start;
